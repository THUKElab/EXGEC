...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        # Add src_tokens into encoder_outs for ExplainableGECTransformerDecoder.forward
        for i in range(len(encoder_outs)):
            encoder_outs[i]["src_tokens"] = [src_tokens]
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            # Pointing index
            if self.model.models[0].cfg.explanation_setting in ["explanation", "rationalization"]:
                vocab_size = self.vocab_size + src_tokens.size(1)
            else:
